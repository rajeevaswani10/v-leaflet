...
@Connect(org.vaadin.addon.leaflet.polylinedecorated.LPolylineDecorated.class)
public class LeafletPolylineDecoratedConnector3
		extends AbstractLeafletVectorConnector2<LeafletPolylineDecoratedState, PolylineOptions> {
	...
	public LeafletPolylineDecoratedConnector3() {
		super();
